<template>
	<div
		...
		:ref="data.id"
		:class="{
			clickable: myHome.toolsState.placingConstructions
		}"
	...
	>
		...
		<div v-if="myHome.toolsState.settingLocations" class="widgetTool zindexer">
...
<style scoped src="../css/construction.css"/>
<script src="../js/construction.js"/>
